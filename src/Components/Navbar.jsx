 ...
 document.body.style.backgroundColor="black"
  ...
  return (
    <div className="justify-around flex border-none h-20 items-center bg-white">
      <a href="\">
   <div><img className="h-20 object-fill outline-none cursor-pointer" src="file:///c%3A/Users/prade/OneDrive/Desktop/coding/my-project/Indian-mart/public/logo/logo.png" alt="" /></div></a>
